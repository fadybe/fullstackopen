  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          content
          <input name="content" {...content.destructureWithoutReset()} />
        </div>
        <div>
          author
          <input name="author" {...author.destructureWithoutReset()} />
        </div>
        <div>
          url for more info
          <input name="info" {...info.destructureWithoutReset()} />
        </div>
...
const App = () => {
  ...
  const addNew = (anecdote) => {
    ...
    setNotification(
      `A new anecdote with content: ${anecdote.content} was created!`
    );
    setTimeout(() => {
